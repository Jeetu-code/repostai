...
return(
<>
<div className="mt-20 w-fit sm:w-xl md:w-3xl lg:w-4xl  mx-auto  bg-white rounded-2xl h-auto p-7 shadow-xl">

{isvalid ?<div className="bg-red-100 py-5 px-3 border-2 border-red-200 rounded-2xl mb-8">
...
<span className="ml-9 text-red-500 ">You've reached your limit of 3 free generations per day.<span className="font-bold"> Upgrade for unlimited!</span></span>
</div>:""}
...
<select  className="h-15 w-2/5 px-3 cursor-pointer bg-gray-300 rounded-xl border-r-8 border-gray-300 outline-transparent transition-all duration-300 ease-in-out hover:outline-3 hover:outline-indigo-800 "  onChange={(e)=>setdraftPlatform(e.target.value as names)}>
...
<button onClick={onhandledata} disabled={isvalid} className={` ${!isvalid?"cursor-pointer shadow-xl/20  bg-indigo-800 transition duration-200 ease-in-out hover:-translate-y-1 hover:scale-101 hover:shadow-xl/30 active:scale-100 active:translate-y-1 active:shadow-xl/10":"cursor-not-allowed bg-indigo-500 "} flex my-3 text-white font-bold rounded-xl gap-2 w-3/5 items-center justify-center   h-15 ml-3   `}>Generate Magic <ArrowRight/></button> </div>
</div>
